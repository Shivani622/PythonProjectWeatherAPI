...
def getWeather():
    ...
    # Use geopy to get the location coordinates of the city
    ...
    result=obj.timezone_at(lng=location.longitude,lat=location.latitude)
     ...
     # Update the timezone label with the result
    ...
    # Get the current weather data from the JSON response
    ...
    # Update the weather icons and temperature for the upcoming days
    ...
    # Create labels to display the day names
    day1.config(text=first.strftime("%A"))
    
    
    # Calculate the dates for the next seven days
